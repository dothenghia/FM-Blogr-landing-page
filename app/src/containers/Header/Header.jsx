			...
			<div className="container">
				...
				<div className="nav-mobile">
					...
					<div className="nav-mobile-container">
						...
						<label for='nav-mobile__input' className='nav-mobile__menu-btn'><svg width="32" height="18" xmlns="http://www.w3.org/2000/svg"><g fill="#FFF" fill-rule="evenodd"><path d="M0 0h32v2H0zM0 8h32v2H0zM0 16h32v2H0z"/></g></svg></label>

						<label for='nav-mobile__input' className='nav-mobile__overlay'></label>

						<nav className="nav-mobile__modal">
							<label for='nav-mobile__input' className='nav-mobile__close-btn'>
							...
							<ul className="mobile__drop">
								<li className="mobile__drop-lists">
									Product
